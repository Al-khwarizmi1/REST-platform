...
abstract class AbstractModel implements \ArrayAccess
{
	 ...
	 * 
	 * You need to enter the "keys" of the $_data array to have 
	 * xml elements associated with their values
	 *
	 ...
	 * 
	 * This will automattically create an index if one does not exist
	 *
	 * @deprecated Don't use this method if you're trying to return values with json
	 * Use the Response object with the "withJson()" function instead
	 * 
	 * @param array $keys array of required keys
	 * @return string
	 */
	...
	public function __call($method, $args)
	{
		...
		throw new Exception(
				printf('Invalid method %1::%2', [get_class($this), $method])
				);
	}
	 ...
	 * @return bool
	 */
	public function isObjectDataEmpty()
	{
		if (empty($this->_data)) {
			return true;
		}
